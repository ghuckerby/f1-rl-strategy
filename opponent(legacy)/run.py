...
from agents.train_ppo import train_f1_ppo, evaluate_ppo_model
from agents.train_dqn import evaluate_model, train_f1_agent
from visualisation.visualise import visualise_model
from visualisation.animate import animate_model
...
def main():
    ...
    eval_parser.add_argument("--model", type=str, default="models/f1_rl_dqn_opponent.zip", help="Path to the trained model")
    ...
    eval_ppo_parser.add_argument("--model", type=str, default="models/f1_rl_ppo_opponent.zip", help="Path to the trained model")
    eval_ppo_parser.add_argument("--vecnormalize", type=str, default="models/f1_rl_ppo_opponent_vecnormalize.pkl", 
    ...
    vis_parser.add_argument("--model", type=str, default="models/f1_rl_dqn_opponent.zip", help="Path to the trained model")
    vis_parser.add_argument("--output", type=str, default="logs/race_summary.png", help="Output path for the plot")

    # Visualise PPO command
    vis_ppo_parser = subparsers.add_parser("visualise-ppo", help="Run a race and plot results (PPO)")
    vis_ppo_parser.add_argument("--model", type=str, default="models/f1_rl_ppo_opponent.zip", help="Path to the trained model")
    vis_ppo_parser.add_argument("--output", type=str, default="logs/race_summary_ppo.png", help="Output path for the plot")
    vis_ppo_parser.add_argument("--vecnormalize", type=str, default="models/f1_rl_ppo_opponent_vecnormalize.pkl", 
                                  help="Path to VecNormalize stats")
    
    # Animate PPO command
    animate_ppo_parser = subparsers.add_parser("animate-ppo", help="Animate a race (PPO)")
    animate_ppo_parser.add_argument("--model", type=str, default="models/f1_rl_ppo_opponent.zip", help="Path to the trained model")
    animate_ppo_parser.add_argument("--output", type=str, default="logs/race_animation_ppo.gif", help="Output path for the animation")
    animate_ppo_parser.add_argument("--vecnormalize", type=str, default="models/f1_rl_ppo_opponent_vecnormalize.pkl", 
                                  help="Path to VecNormalize stats")
