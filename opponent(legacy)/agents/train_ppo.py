...
def train_f1_ppo(
    ...
    run = None
    if use_wandb:
        run_name = run_name or f"f1_ppo_opponent_{total_timesteps // 1_000_000}M"
        run = wandb.init(
...
def evaluate_ppo_model(
    model_path: str = "models/f1_rl_ppo_opponent.zip",
    vecnormalize_path: Optional[str] = "models/f1_rl_ppo_opponent_vecnormalize.pkl",
