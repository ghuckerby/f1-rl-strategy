...
class F1PitStopEnv(gym.Env):
    ...
    def step(self, action: int):
        ...
        # Check for safety car event at the start of the lap
        self.safety_car_active = np.random.random() < self.track.safety_car_probability
        ...
        # Action 1, 2, 3: Pitting
            ...
            self.pit_stops += 1
            pitted = True
            # Use reduced pit loss if safety car is active
            pit_time = self.track.pit_loss_safety_car if self.safety_car_active else self.track.pit_loss
            new_compound = {1: SOFT, 2: MEDIUM, 3: HARD}[action]
        ...
        info = {
            ...
            "safety_car": bool(self.safety_car_active),
        }
        self.race_log.append(info)
